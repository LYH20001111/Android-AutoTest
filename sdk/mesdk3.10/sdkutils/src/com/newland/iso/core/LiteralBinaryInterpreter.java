...
public class LiteralBinaryInterpreter implements BinaryInterpreter
{
     ...
     * @see com.newland.iso.core.jpos.iso.BinaryInterpreter#interpret(byte[], byte[], int)
     */
     ...
     * @see com.newland.iso.core.jpos.iso.BinaryInterpreter#uninterpret(byte[], int, int)
     */
     ...
     * @see com.newland.iso.core.jpos.iso.BinaryInterpreter#getPackedLength(int)
     */
