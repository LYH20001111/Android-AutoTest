...
typedef enum{
	...
	SEC_DES_MODE_ECB = (0<<3),
	SEC_DES_MODE_CBC = (1<<3),
...
extern int (*NDK_NL_RfidPiccDetect)(uchar *psPiccType);
extern char* (*NDK_EMVGetVersion)(void);
extern char* (*EMV_SpGetVersion)(void);
typedef struct {
	char *name;
	char *code;
	char *desc;
...
#define SYS_EVENT_TIMEOUT  (22*60*60*1000)//max 23
