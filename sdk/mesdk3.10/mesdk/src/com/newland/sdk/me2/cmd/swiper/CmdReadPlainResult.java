...
@CommandEntity(cmdCode = { (byte)0xD1,(byte)0x04 }, responseClass = CmdReadPlainResultResponse.class)
public class CmdReadPlainResult extends CommonDeviceCommand {
	...
	public CmdReadPlainResult(SwiperReadModel[] readModels){
	...
	@ResponseEntity
	public static class CmdReadPlainResultResponse extends AbstractSuccessResponse {
		...
		@InstructionField( name = "主账号",index=2,fixLen = 10,maxLen=10,serializer=AccountSerializer.class)
