...
import com.newland.sdk.me2.cmd.pininput.CmdStartStandardPinInputForSM4.CmdStartStandardPinInputForSM4Response;
import com.newland.sdk.me2.cmd.pininput.CmdStartStandardPinInputForSM4.CmdStartStandardPinInputForSM4NotificationResponse;

@CommandEntity(cmdCode = { (byte) 0x1A, (byte) 0x01 }, responseClass = CmdStartStandardPinInputForSM4Response.class, notificationResponseClass = CmdStartStandardPinInputForSM4NotificationResponse.class)
public class CmdStartStandardPinInputForSM4 extends AbortableDeviceCommand {
	...
	@InstructionField(name = "是否启用回车键", index = 7, fixLen = 1, maxLen = 1, serializer = CmdStartStandardPinInput.PinConfirmTypeSerializer.class)
	...
	public CmdStartStandardPinInputForSM4(int keyIndex, byte[] wkData, int pinManageType, AccountInputType acctInputType, String acctSymbol, int inputMaxLen, byte[] pinPadding, PinConfirmType pinConfirmType, String displayContent, int timeout, byte[] pwdInputRange, int pinblockModel) {
		if(wkData!=null){
	...
	@ResponseEntity
	public static class CmdStartStandardPinInputForSM4Response extends
		...
		@InstructionField(name = "加密后的PIN BLOCK", index = 2, fixLen =16 , maxLen =16 , serializer = ByteArrSerializer.class)
	...
	@ResponseEntity
	public static class CmdStartStandardPinInputForSM4NotificationResponse extends
