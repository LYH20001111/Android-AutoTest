...
import com.newland.sdk.me.cmd.serializer.ICCardClassSerializer2;
...
@CommandEntity(cmdCode = { (byte)0xE1,(byte)0x03 }, responseClass = CmdICCardPowerOn.CmdICCardPowerOnResponse.class)
public class CmdICCardPowerOn extends CommonDeviceCommand{
	...
	@InstructionField( name = "卡类型",index = 1,fixLen = 1, maxLen = 1,serializer = ICCardClassSerializer2.class)
