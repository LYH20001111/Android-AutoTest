...
@CommandEntity(cmdCode = { (byte) 0xE2, (byte) 0x09 }, responseClass = CmdM1CardReadData.CmdM1CardReadDataResponse.class)
public class CmdM1CardReadData extends CommonDeviceCommand {
	...
	public static class CmdM1CardReadDataResponse extends AbstractSuccessResponse {
		@InstructionField(name = "Data", index = 0, fixLen = 16, maxLen = 16, serializer = ByteArrSerializer.class)
		private byte[] data;
