...
public class SDKExecutors {
	...
	private static final ExecutorService mThreadPool = SDKExecutors.newCachedThreadPool(3);
	public static ExecutorService getThreadPoolInstance(){
		return mThreadPool;
	}

	private static final ExecutorService mFixedThreadPool = Executors.newFixedThreadPool(3);
    ...
    public static void startThread(Runnable runnable){
		SDKExecutors.getThreadPoolInstance().submit(runnable);
	}
}
