...
@CommandEntity(cmdCode = {(byte) 0xE2, (byte) 0x06}, responseClass = CmdM1CardAuthenticate.CmdM1CardAuthenticateResponse.class)
public class CmdM1CardAuthenticate extends CommonDeviceCommand {
    ...
    @InstructionField(name = "SNR", index = 1, maxLen = 32, serializer = ByteArrSerializer.class)
    private byte[] SNR;
