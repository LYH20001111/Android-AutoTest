...
@CommandEntity(cmdCode = { (byte) 0xE2, (byte) 0x09 }, responseClass = CmdM1CardIncrement.CmdRFCardIncrementResponse.class)
public class CmdM1CardIncrement extends CommonDeviceCommand {
	...
	@ResponseEntity
	public static class CmdRFCardIncrementResponse extends AbstractSuccessResponse {
	}
