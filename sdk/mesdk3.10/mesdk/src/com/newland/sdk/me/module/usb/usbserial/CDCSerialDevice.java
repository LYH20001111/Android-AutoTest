...
public class CDCSerialDevice extends UsbSerialDevice
{
    ...
    public static final int CDC_VID_1659 = 1659;
    public static final int CDC_PID_9171 = 9171;
    /***
...
//                Utils.d("CDCSerialDevice dataReceived="+ ISOUtils.hexString(dataReceived));
    ...
    private static int findFirstCDC(UsbDevice device)
    {
        ...
        Log.i(CLASS_ID,"findFirstCDC-interfaceCount" + interfaceCount);
        ...
        for (int iIndex = 0; iIndex < interfaceCount; ++iIndex)
        {
            ...
            if(iIndex==0 && vid == CDCSerialDevice.CDC_VID_1659 && pid == CDCSerialDevice.CDC_PID_9171){
                Log.d(CLASS_ID,"vid="+vid+" pid="+pid+" cdc.");
                return iIndex;
            }
