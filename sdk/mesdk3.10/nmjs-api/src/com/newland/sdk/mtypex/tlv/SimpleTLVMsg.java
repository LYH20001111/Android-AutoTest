...
public class SimpleTLVMsg implements TLVMsg{
     ...
     * @param value 
     */
    public SimpleTLVMsg(int tag, byte[] value) {
        setTag(tag);
        this.value = value;
    }
    ...
    /**
     * @param newValue  Value of TLV Message
     */
    ...
    public byte[] pack() {
        ...
        byte[] bTag = InnerUtils.hex2byte(hexVal);
        byte[] bLen = getL();
        if (value != null) {
    ...
    public String toHexString() {
        return InnerUtils.hexString(value);
    }
}
