...
/**
 * Author by bxy, Date on 2019/4/9 0009.
 */
...
public class ExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    //  Get the number of children of group
    @Override
    ...
    public View getGroupView(int parentPos, boolean isExpanded, View convertView, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            holder.groupName = (TextView)view.findViewById(R.id.id_parent_title);
            holder.arrow = (ImageView)view.findViewById(R.id.id_parent_arrow);
            view.setTag(holder);
        }else{
    ...
    public View getChildView(int parentPos, int childPos, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            holder.childName = (TextView)view.findViewById(R.id.id_name);
            holder.finddesc = (TextView)view.findViewById(R.id.id_finddesc);
            view.setTag(holder);
        }else{
    ...
    // Check whether the child is selectable. If the click event of the child needs to be set, return true.
    @Override
