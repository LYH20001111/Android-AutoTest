    ...
    private PinInputListener pinInputListener = new PinInputListener() {
        ...
        public void onFinish(int pinblockLen, byte[] pinblock,byte[] ksn) {
            ...
            if (pinblockLen == 0) {
                ...
                Log.i(TAG, getString(R.string.keyboard_activity_log_input_success) + (pinblock==null?null:ISOUtils.hexString(pinblock))+"ksn:"+(ksn==null?null:ISOUtils.hexString(ksn)));
                Intent i = new Intent();
