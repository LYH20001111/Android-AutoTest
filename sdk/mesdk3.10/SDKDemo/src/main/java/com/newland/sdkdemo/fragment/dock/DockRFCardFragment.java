...
import com.newland.sdk.inter.externalrfcard.ExtRFCardModule;
import com.newland.sdk.inter.externalrfcard.LightColor;
import com.newland.sdk.inter.externalrfcard.LightState;
import com.newland.sdk.inter.externalrfcard.RFCardType;
import com.newland.sdk.inter.externalrfcard.RFKeyMode;
import com.newland.sdk.inter.externalrfcard.RFResult;
import com.newland.sdk.pinpad.utils.Dump;
...
public class DockRFCardFragment extends BaseFragment {
    ...
    public DockRFCardFragment(Context context) {
    ...
    public void initData() {
        extRFCard = DeviceController.getInstance().getExtRFCardModule();
    }

    @Override
    public Object getModule() {
        return DockRFCardFragment.this;
    }
        ...
        DialogUtils.createSingleChoiceDialog(context, context.getString(R.string.msg_select_access_type), accessTypes, new DialogUtils.SingleChoiceDialogCallback() {
            ...
            public void onResult(int id) {
                ...
                SDKExecutors.getFixedThreadPoolInstance().submit(()->{
                    boolean init = extRFCard.init(CommunicationTool.getInstance().getCommunicationListener(),extParams);
                    if (init) {
