...
import com.newland.sdkdemo.adapter.ExpandableListViewAdapter;
import com.newland.sdkdemo.adapter.ExpandableListViewParent;
import com.newland.sdkdemo.adapter.ExpandableListViewSon;
...
import com.newland.sdkdemo.annotation.MethodBean;
import com.newland.sdkdemo.annotation.MethodEntity;
import com.newland.sdkdemo.annotation.MethodGridBean;
import com.newland.sdkdemo.annotation.MethodGridEntity;
import com.newland.sdkdemo.annotation.MethodGroupBean;
import com.newland.sdkdemo.annotation.MethodGroupEntity;
...
public abstract class BaseFragment implements AdapterView.OnItemClickListener{
    ...
    protected void switchFragment(BaseFragment baseFragment){
        ((MainActivity)context).runOnUiThread(()->{
            ((MainActivity)context).switchFragment(baseFragment);
        });
    }
    protected void showImage(Bitmap bmp){
        ((MainActivity)context).showImage(bmp);
    }
    ...
    private View initExListView(){
        ...
        exlistView = (ExpandableListView) view.findViewById(R.id.id_exlistview);
        return view;
    }
    ...
    private View initRecycleView(){
        ...
        recycleview = (RecyclerView)view.findViewById(R.id.id_recycleview);
        return view;
    }
    ...
    protected ArrayList<MethodGridBean> getModuleMethodsGrid(Object module){
        try {
            ...
            Class clazz = module.getClass();
            findMethodGridEntity(clazz,gridList,module);
            clazz = module.getClass().getSuperclass();
            findMethodGridEntity(clazz,gridList,module);
    ...
    private void findMethodGridEntity(Class clazz,ArrayList<MethodGridBean> gridList,Object module){
        Method[] mothods = clazz.getDeclaredMethods();
        for(Method method : mothods){
