 ...
 * STYLE_1
 */
public class DRNIBPinKeyBoard extends View{
    private DeviceLogger devicelogger = DeviceLoggerFactory.getLogger(DRNIBPinKeyBoard.class.getSimpleName());
    ...
    public DRNIBPinKeyBoard(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public DRNIBPinKeyBoard(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
