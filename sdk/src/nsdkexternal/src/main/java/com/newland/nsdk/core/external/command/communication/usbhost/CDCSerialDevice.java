...
public class CDCSerialDevice extends UsbSerialDevice {
    ...
    private boolean openCDC() {
        if (connection.claimInterface(mInterface, true)) {
            LogUtils.i(CLASS_ID, "Interface succesfully claimed");
        } else {
            LogUtils.i(CLASS_ID, "Interface could not be claimed");
            return false;
        }
        ...
        if (outEndpoint == null || inEndpoint == null) {
            LogUtils.i(CLASS_ID, "Interface does not have an IN or OUT interface");
            return false;
        }
    ...
    private int setControlCommand(int request, int value, byte[] data) {
        ...
        LogUtils.i(CLASS_ID, "Control Transfer Response: " + response);
        return response;
    }
    ...
    private static int findFirstCDC(UsbDevice device) {
        ...
        LogUtils.i(CLASS_ID, "There is no CDC class interface");
        return -1;
    }
