...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            parentLayout = view.findViewById(R.id.id_recycleviewitem);
            name = view.findViewById(R.id.id_name);
            if (itemType == RecyclerViewType.ROW3_SMALL) {
                number = view.findViewById(R.id.id_number);
            } else if (itemType == RecyclerViewType.ROW3_BIG) {
                imageView = view.findViewById(R.id.id_imageview);
            }
            btnLayOut = view.findViewById(R.id.id_btnlayout);
            tvTip = view.findViewById(R.id.id_tip);
        }
    }
