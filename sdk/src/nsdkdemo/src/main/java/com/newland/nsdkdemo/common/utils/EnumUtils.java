...
public class EnumUtils {
    ...
    public static int getFocusMode(String tempStr) {
        switch (tempStr) {
            case "OFF":
                return ScanUtil.FOCUS_OFF;
            case "ON":
                return ScanUtil.FOCUS_ON;
            default:
                return ScanUtil.FOCUS_READING;
        }
    }

    public static AntiRemovalStatus getAntiRemovalStatus(String tempStr) {
        for (AntiRemovalStatus antiRemovalStatus : AntiRemovalStatus.values()) {
            if (tempStr.equals(antiRemovalStatus.name())) {
