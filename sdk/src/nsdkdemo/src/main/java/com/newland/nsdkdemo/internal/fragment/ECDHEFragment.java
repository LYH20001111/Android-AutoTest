...
public class ECDHEFragment extends InternalBaseFragment {

    private ECDHEImpl ecdhe;
    private SharedPreferences sharedPreferences;
    private SharedPreferences.Editor mEditor;
    private KeyManager keyManager;
    private byte[] PublicKey = null;
    public ECDHEFragment(Context context) {
    ...
    public void initData() {
        ...
        sharedPreferences = context.getSharedPreferences("ECDHE", Context.MODE_PRIVATE);
        mEditor = sharedPreferences.edit();
    }

    @Override
    public Object getModule() {
        return ECDHEFragment.this;
    }
    ...
    @MethodGridEntity(btnnameid = R.string.ecdhe_process_google_smart_pay, functionid = 5)
    private void googlePayProcess() {
        byte[] info = ISOUtils.hex2byte("");
        byte[] mobile_pubkey = ISOUtils.hex2byte("033B1EF8F78333EEE49A92A43ADE89365ADDBCAE8D7036F2CD9B83870197FB683D");
        try {
            ecdhe.init();
            byte[] publicKey = ecdhe.generateKeyPair(ECCType.P_256);
            showMessage("Generate Key Pair:" + ISOUtils.hexString(publicKey));
            SymmetricKey sessionKey = new SymmetricKey();
            ...
            kdfInfo.setInfo(info);
            kdfInfo.setUcInfoLen((byte) info.length);
            kdfInfo.setSalt(mobile_pubkey);
            kdfInfo.setUcSaltLen((byte) mobile_pubkey.length);
            kdfInfo.setMessageDigestType(MessageDigestType.SHA256);
            kdfInfo.setKDFType(KDFType.HKDF_GOOGLE_SMART_TAP);
            ecdhe.generateSessionKey(sessionKey, kdfInfo, publicKey);
            showMessage(context.getString(R.string.ecdhe_generate_sk));
            ecdhe.release();
            showMessage(context.getString(R.string.ecdhe_release));
        } catch (NSDKException e) {
