...
public class RNIBPinKeyBoard extends View{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, height / 5 * 3 + 1, width / 3 + 1, height, paint);

        //Backspace
        setPaintColor(1, paint);
        canvas.drawRect(width / 3 + 1, height / 5 * 4, width / 3 * 2, height, paint);

        //Enter
        setPaintColor(2,paint);
        canvas.drawRect(width / 3 * 2 + 1, height / 5 * 3 + 1, width, height, paint);
        ...
        canvas.drawLine(width / 3 - 5, height / 5 * 4, width / 3 * 2 - 5, height / 5 * 4, paint);
    ...
    public Map<PINPadButton, int[]> getButtonsCoordinates() {
        ...
        Log.d("RNIB", "X:" + setLogCoordination(x0, y3, x1, y5));
        Log.d("RNIB", "<:" + setLogCoordination(x1, y4, x2, y5));
        Log.d("RNIB", "√:" + setLogCoordination(x2, y3, x3, y5));
