...
/**
 * Parameters that used for PIN input.
 */
public class PINEntryParameters {
    ...
    private boolean checkPINRange = false;
    ...
    /**
     * Gets whether to check the length of the entered PIN is valid when PIN entry process finished.
     * @return Whether to check the length of the entered PIN is valid when PIN entry process finished.
     */
    public boolean isCheckPINRange() {
        return checkPINRange;
    }

    /**
     * Sets whether to check the length of the entered PIN is valid when PIN entry process finished.
     * @param checkPINRange Whether to check the length of the entered PIN is valid when PIN entry process finished.
     */
    public void setCheckPINRange(boolean checkPINRange) {
        this.checkPINRange = checkPINRange;
    }
